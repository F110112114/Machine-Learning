...
class TrainModel:
    ...
    def __init__(self, board_len=10, lr=0.01, n_self_plays=1500, n_mcts_iters=500,
                 n_feature_planes=4, batch_size=512, start_train_size=500, check_frequency=50,
                 n_test_games=20, c_puct=4, is_use_gpu=True, is_save_game=True, **kwargs):
        """
        Parameters
        ----------
        board_len: int
